      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-stone-100">OnboardingTimeToValueTracker</span>
          </Link>
          <h1 className="text-2xl font-bold mt-6 text-stone-100">Create your account</h1>
          <p className="mt-1 text-sm text-stone-400">Start measuring onboarding time-to-value for free.</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-stone-900 rounded-xl border border-stone-800 p-8 space-y-4">
          ...
          <div>
            ...
            <input name="email" type="email" required className="w-full bg-stone-800 border border-stone-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-rose-500" placeholder="you@example.com" />
          </div>
          <div>
          ...
          <button type="submit" disabled={loading} className="w-full bg-rose-500 hover:bg-rose-400 disabled:opacity-50 text-stone-950 py-3 rounded-lg font-semibold transition-colors">
